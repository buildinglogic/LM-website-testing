...
import { ArrowRight, Lock, Calculator } from "lucide-react"

const PRODUCT = "tariffiq"
const PRODUCT_NAME = "TariffIQ"
const PRODUCT_COLOR = "#1B4F8A"
const YOUTUBE_ID = "GozRgIrKy6U"
const TAGLINE = "HSN Classification & Duty"
          ...
          <div className={`text-center mb-6 transition-all duration-500 delay-100 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            <div className="flex items-center justify-center gap-2.5 mb-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: `${PRODUCT_COLOR}12` }}>
                <Calculator className="w-5 h-5" style={{ color: PRODUCT_COLOR }} />
              </div>
